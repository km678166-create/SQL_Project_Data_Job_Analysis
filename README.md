...
The data for this analysis is from Luke Barousse’s [SQL Course] (https://www.youtube.com/watch?v=7mz73uXD9DA). This data includes details on job titles, salaries, locations, and required skills.
...
WHERE 
    job_title = 'Data Analyst' AND job_location = 'Anywhere' AND salary_year_avg IS NOT NULL
ORDER BY 
